...
This repository presents the experimental results and implementation for our paper **Explainable deepfake detection using reinforcement learning enhanced self-blended images**(Accepted by ICASSP2026). Our work addresses the critical need for interpretable deepfake detection methods while reducing annotation costs through automated data generation.
...
### **Data Preparation**
We utilized the DDVQA test set, extracting one frame per video for a total of 262 images. We compared the text descriptions generated by our final model against the original textual descriptions from DDVQA.

### **Participants**
We recruited 5 well-educated participants and provided them with a 20-minute training session regarding the evaluation criteria.

### **Results**
Our method achieved an average score of **3.7**, compared to **2.4** for DDVQA. 
DDVQA's descriptions often contained non-factual or ambiguous statements, whereas our model’s outputs were relatively more accurate.
...
```
### **Results**
Our method achieved an average score of **2.5**, compaired to **1.9** for DDVQA.
